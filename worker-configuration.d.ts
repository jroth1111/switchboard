/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.jsonc --env-file fixtures/wrangler-types.env` (hash: faf372535402f635d6ce117124a039a8)
// Runtime types generated with workerd@1.20260507.1 2025-11-17
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ControlPlaneStateDO" | "OAuthAccountDO";
	}
	interface Env {
		CONTROL_PLANE_STATE: DurableObjectNamespace<import("./src/index").ControlPlaneStateDO>;
